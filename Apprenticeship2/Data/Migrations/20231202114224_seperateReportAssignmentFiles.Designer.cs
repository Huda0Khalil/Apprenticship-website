...
namespace Apprenticeship2.Data.Migrations
{
    ...
    [Migration("20231202114224_seperateReportAssignmentFiles")]
    partial class seperateReportAssignmentFiles
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Apprenticeship2.Data.Entities.AssignmentFiles", b =>
                {
                    b.Property<int>("assignmentFilesId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("assignmentFilesId"), 1L, 1);
                    ...
                    b.HasKey("assignmentFilesId");

                    b.HasIndex("AssignmentId");

                    b.HasIndex("reportId");

                    b.HasIndex("reportLogId");
            ...
            modelBuilder.Entity("Apprenticeship2.Data.Entities.ReportFiles", b =>
                {
                    b.Property<int>("reportFilesId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("reportFilesId"), 1L, 1);
            ...
            modelBuilder.Entity("Apprenticeship2.Data.Entities.AssignmentFiles", b =>
                {
                    ...
                    b.HasOne("Apprenticeship2.Data.Entities.Report", null)
                        .WithMany("fileAttatchments")
                        .HasForeignKey("reportId");

                    b.HasOne("Apprenticeship2.Data.Entities.ReportLog", null)
                        .WithMany("fileAttatchments")
                        .HasForeignKey("reportLogId");
            ...
            modelBuilder.Entity("Apprenticeship2.Data.Entities.ReportFiles", b =>
                {
                    ...
                    b.HasOne("Apprenticeship2.Data.Entities.ReportLog", "reportLog")
                        .WithMany()
                        .HasForeignKey("reportLogId");
